...
class Tenant(Base):
    ...
    source_static_urls_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    source_domain_aliases: Mapped[str | None] = mapped_column(Text, nullable=True)
    source_canonical_base_url: Mapped[str | None] = mapped_column(String(1024), nullable=True)
    brand_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    widget_primary_color: Mapped[str | None] = mapped_column(String(20), nullable=True)
    widget_website_url: Mapped[str | None] = mapped_column(String(1024), nullable=True)
...
class ChatSession(Base):
    ...
    active_filters_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    user_preferences_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    last_result_context_json: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    conversation_intent: Mapped[str | None] = mapped_column(String(64), nullable=True)
